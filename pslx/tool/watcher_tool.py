...
class LocalPartitionerWatcher(Base):
    ...
    def __init__(self, partitioner, delay=TimeSleepObj.ONE_TENTH_SECOND, timeout=-1):
        super().__init__()
...
class RemotePartitionerWatcher(Base):
    ...
    def __init__(self, partitioner_dir, server_url, root_certificate=None, delay=TimeSleepObj.ONE_TENTH_SECOND, timeout=-1):
        super().__init__()
