...
class FileUtilTest(unittest.TestCase):
    ...
    def test_join_paths_to_file(self):
        ...
        base_name = 'foo'
        ttl = 1
        self.assertEqual(FileUtil.join_paths_to_file(root_dir, base_name, ttl), 'database/foo/ttl=1')

    def test_join_paths_to_dir(self):
        root_dir = 'database'
        base_name = 'foo'
        ttl = 1
        self.assertEqual(FileUtil.join_paths_to_dir(root_dir, base_name, ttl), 'database/foo/ttl=1/')
