...
class TreeBaseTest(unittest.TestCase):
    ...
    def test_get_sub_tree_size(self):
        ...
        self.assertEqual(test_tree.get_num_nodes_subtree(node=test_parent_node), 3)
        self.assertEqual(test_tree.get_num_nodes_subtree(node=test_child_node_1), 2)
    ...
    def test_bfs_search(self):
        ...
        self.assertListEqual(
            ...
            [('test_parent_node', 0), ('test_child_node_1', 1), ('test_child_node_2', 1)]
        )
        self.assertListEqual(
            test_tree.bfs_search(max_num_node=2),
            [('test_parent_node', 0), ('test_child_node_1', 1)]
        )
    ...
    def test_dfs_search(self):
        ...
        self.assertListEqual(
            test_tree.dfs_search(max_num_node=-1),
            [('test_parent_node', 0), ('test_child_node_3', 1), ('test_child_node_1', 1), ('test_child_node_2', 2)]
        )
        ...
        self.assertListEqual(
            test_tree.dfs_search(max_num_node=-1),
            [('test_parent_node', 0), ('test_child_node_3', 1), ('test_child_node_4', 2), ('test_child_node_1', 1),
             ('test_child_node_2', 2)]
        )
        ...
        self.assertListEqual(
            test_tree.dfs_search(max_num_node=-1),
            [('test_parent_node', 0), ('test_child_node_3', 1), ('test_child_node_5', 2), ('test_child_node_4', 2),
             ('test_child_node_1', 1), ('test_child_node_2', 2)]
        )
